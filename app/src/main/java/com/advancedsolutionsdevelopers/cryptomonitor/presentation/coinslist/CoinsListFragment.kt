...
class CoinsListFragment : BaseFragment<CoinsListState, CoinsListEvent>(R.layout.fragment_coins_list) {
    override val binding by viewBinding(FragmentCoinsListBinding::bind)
